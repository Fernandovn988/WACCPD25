from auxiliar_NN import MLP, init_weights, assign_weights_to_model
...
def train_main_network(x_train, y_train):
    ...
    encaps_function.build(torch_model, optimizer, criterion, optimizer_parameters, num_gpu=4, num_nodes=2)
    start_time = time.time()
    trained_weights = encaps_function.fit_asynchronous_with_GPU(x_train, y_train, 2543, 32, shuffle_blocks=False, shuffle_block_data=True)
