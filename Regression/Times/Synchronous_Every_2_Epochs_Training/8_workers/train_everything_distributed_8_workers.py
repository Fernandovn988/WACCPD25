...
def train_main_network(x_train, y_train):
    ...
    trained_weights = encaps_function.fit_synchronous_every_n_epochs_with_GPU(x_train, y_train, 2543, 32, n_epocs_sync=2, shuffle_blocks=False, shuffle_block_data=True)
