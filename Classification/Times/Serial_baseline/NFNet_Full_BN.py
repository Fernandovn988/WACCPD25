...
class NFNet(nn.Module):
    def __init__(self, num_classes=10, alpha=0.2):
        ...
        self.neural_network_layers = nn.Sequential(
                ...
                NFBlockBN(64, 128, stride=1, alpha=self.alpha),
                NFBlockBN(128, 256, stride=1, alpha=self.alpha),
                NFBlockBN(256, 512, stride=2, alpha=self.alpha),
                NFBlockBN(512, 1024, stride=2, alpha=self.alpha),
