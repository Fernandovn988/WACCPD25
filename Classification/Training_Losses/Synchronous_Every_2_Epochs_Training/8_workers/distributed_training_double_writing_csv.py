...
def train_main_network(x_train, y_train, x_test, y_test):
    ...
    trained_weights, train_loss, train_acc, validation_loss, val_acc = encaps_function.fit_synchronous_every_n_epochs_with_GPU(x_train, y_train, num_batches, 50, n_epocs_sync=2, return_loss=True, x_test=x_test, y_test=y_test) 
